...
public class configFTP extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (control.equals("status")) {
                ...
                String see = seeFTP(control, host, port, user, password);
                request.setAttribute("see", see);
                request.getRequestDispatcher("ftp.jsp").forward(request, response);
            } else {
                response.sendRedirect("./ftp.jsp");
            }
        } catch (Exception e) {
        }
    }

    public String configFTP(String control, String host, int port, String user, String password) {
        String result = "";
        ...
        try {
            ...
            result = "Đã " + control + " dịch vụ FTP thành công <br>" + outBuff.toString();
            channel.disconnect();
            session.disconnect();
    ...
    public String statusFTP(String host, int port, String user, String password) {
        String result = "";
    ...
    public String seeFTP(String control, String host, int port, String user, String password) {
